    ...
    render(){
        return(
            <div id="about-page" className="container">
                ...
                All code for this tool is on the <a href="https://github.com/leklab/mito_visualize" target="_blank">GitHub repository</a>.
                
                <br />
                
                To share feedback or suggest improvements, please leave a message (as an issue) on the 
                <a href="https://github.com/leklab/mito_visualize/issues" target="_blank">github repository</a>.
                
                <br/>
                
                For general enquiries please email mitovisualize@gmail.com.
                
                <br /><br />

                <b>Acknowledgements of Data Sources:</b>
                ...
                <b>Variant data & API:</b>
                
                <br />
                
                The variant annotations can be downloaded in tsv format via the 'Download Variant Data' button at the bottom of each variant page. 
